...
<div class="screen">
    <div class="header">
        ...
        <h1 class="header-title">نظرات و پیشنهادات</h1>
        <div class="header-line"></div>
    </div>


    <a href="{{ route('suggestions.create') }}" class="add-user-row">
        <svg class="add-user-icon" width="28" height="28" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                  d="M12 9v3m0 0v3m0-3h3m-3 0H9m12 0a9 9 0 11-18 0 9 9 0 0118 0z"></path>
        </svg>
        <span class="add-user-text">افزودن نظر  جدید</span>
    </a>
    ...
    <div class="user-list-container">
        @foreach($suggestions as $suggestion)
            <div class="user-item">
                <div class="user-name">{{ $suggestion->title }}</div>
                <div class="user-actions">
                    <!-- Document icon -->
                    <a href="{{ route('suggestions.show',compact('suggestion')) }}">
