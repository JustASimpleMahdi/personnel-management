...
<div class="screen">
    <div class="delete-modal">
        <div class="modal-text">
            آیا از حذف این گزارش<br>مطمئن هستید ؟
        </div>

        <form action="{{ route('manager.reports.destroy',['report' => $report]) }}" method="post" class="modal-actions">
            @csrf
            @method('DELETE')
            <button class="btn">بله</button>


            <a href="{{ route('manager.reports.index') }}" class="btn">خیر</a>
        </form>
    </div>
</div>
